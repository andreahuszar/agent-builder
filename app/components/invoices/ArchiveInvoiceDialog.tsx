      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <DialogFooter className="gap-2 sm:gap-0">
          ...
          <button
            onClick={onConfirm}
            disabled={isLoading}
            className="px-4 py-2 text-sm font-medium text-white bg-purple-900 hover:bg-purple-800 disabled:bg-purple-300 rounded-md transition-colors flex items-center gap-2"
          >
            {isLoading ? (
              <>
