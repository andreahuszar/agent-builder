-- Add more diverse invoices with various exceptions for testing
-- Properly formatted without vendor_id column issues

-- Invoice with price variance (over tolerance)
INSERT INTO invoice_headers (
  id, invoice_number, vendor_name_snapshot, vendor_tax_id_snapshot,
...
INSERT INTO invoice_headers (
  ...
  'HD-2024-0024',
  ARRAY['PO-2024-0021'],
  '[{"field": "invoice_number", "message": "Potential duplicate invoice detected (same as INV-2024-0021)", "severity": "error"}]'::jsonb
) ON CONFLICT (id) DO UPDATE SET 
  match_status = 'exception',
  validation_errors = '[{"field": "invoice_number", "message": "Potential duplicate invoice detected (same as INV-2024-0021)", "severity": "error"}]'::jsonb;
